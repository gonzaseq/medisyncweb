...
<footer class="site-footer">
  <div class="site-footer__inner">
    ...
    <div class="site-footer__brand">
      <a href="index.html" class="site-footer__logo" aria-label="MediSync — Inicio">
        <img src="img/logo.white.png" alt="MediSync Ingeniería Clínica">
      </a>
      <p class="site-footer__tagline">Ingeniería clínica para instituciones de salud.</p>
    </div>

    <!-- Navegación interna -->
    <nav class="site-footer__nav" aria-label="Navegación del pie de página">
      <span class="site-footer__heading">Navegación</span>
      <ul class="site-footer__links">
        <li><a href="index.html"     class="site-footer__link">Inicio</a></li>
        <li><a href="servicios.html" class="site-footer__link">Servicios</a></li>
        <li><a href="equipos.html"   class="site-footer__link">Equipamiento</a></li>
        <li><a href="nosotros.html"  class="site-footer__link">Nosotros</a></li>
        <li><a href="contacto.html"  class="site-footer__link">Contacto</a></li>
      </ul>
    </nav>

    <!-- Redes sociales -->
    <div class="site-footer__social">
      <span class="site-footer__heading">Seguinos</span>
      <div class="site-footer__social-icons">
        <a href="https://www.instagram.com/medi.sync" target="_blank" rel="noopener noreferrer"
           class="site-footer__social-link site-footer__social-link--instagram" aria-label="Instagram">
          <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.334 3.608 1.308.975.975 1.246 2.242 1.308 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.334 2.633-1.308 3.608-.975.975-2.242 1.246-3.608 1.308-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.334-3.608-1.308-.975-.975-1.246-2.242-1.308-3.608C2.175 15.584 2.163 15.204 2.163 12s.012-3.584.07-4.85c.062-1.366.334-2.633 1.308-3.608.975-.975 2.242-1.246 3.608-1.308 1.266-.058 1.646-.07 4.85-.07zm0-2.163c-3.259 0-3.667.014-4.947.072-1.609.074-3.047.49-4.184 1.627C1.732 2.836 1.316 4.274 1.242 5.883 1.184 7.163 1.17 7.571 1.17 12c0 4.429.014 4.837.072 6.117.074 1.609.49 3.047 1.627 4.184 1.137 1.137 2.575 1.553 4.184 1.627C8.333 23.986 8.741 24 12 24s3.667-.014 4.947-.072c1.609-.074 3.047-.49 4.184-1.627 1.137-1.137 1.553-2.575 1.627-4.184.058-1.28.072-1.688.072-6.117 0-4.429-.014-4.837-.072-6.117-.074-1.609-.49-3.047-1.627-4.184C19.994 1.732 18.556 1.316 16.947 1.242 15.667 1.184 15.259 1.17 12 1.17zm0 5.838a5.163 5.163 0 100 10.326 5.163 5.163 0 000-10.326zm0 8.163a3 3 0 110-6 3 3 0 010 6zm5.338-9.87a1.2 1.2 0 100 2.4 1.2 1.2 0 000-2.4z"/></svg>
        </a>
        <a href="https://www.linkedin.com/company/medi-sync-arg" target="_blank" rel="noopener noreferrer"
           class="site-footer__social-link site-footer__social-link--linkedin" aria-label="LinkedIn">
